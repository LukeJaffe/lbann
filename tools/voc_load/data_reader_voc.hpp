...
//
// data_reader_voc .hpp .cpp - generic_data_reader class for VOC files
////////////////////////////////////////////////////////////////////////////////
...
/**
 * Data reader for VOC (and similar) files.
 ...
 */
class data_reader_voc : public generic_data_reader {
 public:
  /**
  ...
  /// Set whether the VOC file has a header; default true.
  ...
  /**
   * This parses the header of the VOC to determine column information.
   */
  void load() override;
  ...
  /**
   * Return the parsed VOC line and store the label and response in the m_labels
 ...
 protected:
  ...
  /**
   * Return the parsed VOC line. This does not extract the label/response.
   */
  ...
  /** Return a raw line from the VOC file. 
   *  (Made public to support data store functionality)
   */
  ...
  int m_skip_rows = 0;
  /// Whether the VOC file has a header.
